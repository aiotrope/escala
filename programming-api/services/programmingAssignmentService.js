...
const updateUserSubmission = async (
  ...
  const userSubmission =
    await sql`update programming_assignment_submissions set grader_feedback=${grader_feedback} status=${status} correct=${correct} 
      where programming_assignment_id=${programming_assignment_id} and user_uuid=${user_uuid} returning grader_feedback, status, correct;`;
